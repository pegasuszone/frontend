...
export type Collection = {
  ...
  provenance?: Maybe<Array<ProvenanceChainInfo>>
...
export enum CollectionMinterType {
...
export type HistoricalAmount = HistoricalData & {
  __typename?: 'HistoricalAmount'
  coinAmount?: Maybe<CoinAmount>
  timestamp: Scalars['DateTime']['output']
  usdAmount?: Maybe<Scalars['Float']['output']>
}
...
export type Offer = {
  ...
  /** @deprecated Use offerPrice instead */
...
export type ProvenanceChainInfo = {
  __typename?: 'ProvenanceChainInfo'
...
export type Query = {
  ...
  collectionFloorPriceTimeSeries?: Maybe<Array<HistoricalAmount>>
...
export type QueryCollectionFloorPriceTimeSeriesArgs = {
  address: Scalars['String']['input']
  timeSeriesSelection?: InputMaybe<TimeSeriesSelectionInput>
}
...
export type QueryCollectionsArgs = {
  ...
  filterByMinterType?: InputMaybe<Array<Scalars['String']['input']>>
  limit?: InputMaybe<Scalars['Int']['input']>
...
export type Token = {
  ...
  expiresAtDateTime?: Maybe<Scalars['DateTime']['output']>
...
export type ProfileWalletQuery = {
  ...
  wallet?: {
    ...
    stats?: { __typename?: 'WalletStats'; address: string } | null
  } | null
}
  ...
  definitions: [
    {
      ...
      operation: 'query',
      name: { kind: 'Name', value: 'OwnedTokens' },
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'ownerAddrOrName' },
                value: {
                  kind: 'Variable',
                  name: { kind: 'Name', value: 'owner' },
                },
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'tokenCounts' },
                              selectionSet: {
                                kind: 'SelectionSet',
                                selections: [
                                  {
...
} as unknown as DocumentNode<OwnedTokensQuery, OwnedTokensQueryVariables>
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'ProfileWallet' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
 ...
 *
 * To run a query within a React component, call `useOwnedTokensQuery` and pass it any options that fit your needs.
 * When your component renders, `useOwnedTokensQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useOwnedTokensQuery(
  baseOptions?: Apollo.QueryHookOptions<
    OwnedTokensQuery,
    OwnedTokensQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<OwnedTokensQuery, OwnedTokensQueryVariables>(
    OwnedTokensDocument,
    options
  )
}
export function useOwnedTokensLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<OwnedTokensQuery, OwnedTokensQueryVariables>(
    OwnedTokensDocument,
    options
  )
}
export function useOwnedTokensSuspenseQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useSuspenseQuery<OwnedTokensQuery, OwnedTokensQueryVariables>(
    OwnedTokensDocument,
    options
  )
}
export type OwnedTokensQueryHookResult = ReturnType<typeof useOwnedTokensQuery>
export type OwnedTokensLazyQueryHookResult = ReturnType<
  typeof useOwnedTokensLazyQuery
>
export type OwnedTokensSuspenseQueryHookResult = ReturnType<
  typeof useOwnedTokensSuspenseQuery
>
export type OwnedTokensQueryResult = Apollo.QueryResult<
  OwnedTokensQuery,
  OwnedTokensQueryVariables
>

/**
 * __useProfileWalletQuery__
 *
 * To run a query within a React component, call `useProfileWalletQuery` and pass it any options that fit your needs.
 * When your component renders, `useProfileWalletQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useProfileWalletQuery({
 *   variables: {
 *      address: // value for 'address'
 *   },
 * });
 */
export function useProfileWalletQuery(
  baseOptions: Apollo.QueryHookOptions<
    ProfileWalletQuery,
    ProfileWalletQueryVariables
  > &
    (
      | { variables: ProfileWalletQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<ProfileWalletQuery, ProfileWalletQueryVariables>(
    ProfileWalletDocument,
    options
  )
}
export function useProfileWalletLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ProfileWalletQuery,
    ProfileWalletQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<ProfileWalletQuery, ProfileWalletQueryVariables>(
    ProfileWalletDocument,
    options
  )
}
export function useProfileWalletSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    ProfileWalletQuery,
    ProfileWalletQueryVariables
  >
  ...
  return Apollo.useSuspenseQuery<
    ProfileWalletQuery,
    ProfileWalletQueryVariables
  >(ProfileWalletDocument, options)
}
export type ProfileWalletQueryHookResult = ReturnType<
  typeof useProfileWalletQuery
>
export type ProfileWalletLazyQueryHookResult = ReturnType<
  typeof useProfileWalletLazyQuery
>
export type ProfileWalletSuspenseQueryHookResult = ReturnType<
  typeof useProfileWalletSuspenseQuery
>
